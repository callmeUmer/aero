...
class mainWindow(QMainWindow, Ui_MainWindow):
    ...
    def openFileNameDialog(self):
        ...
        filename, _= QFileDialog.getOpenFileName(self,"Open Files", "","All Files (*);;Python Files (*.py);; C++ Files (*.cpp)", options=options)
        if filename:
    ...
    def saveFile(self):
        if self.FILENAME:
            ...
            QMessageBox.warning(self, 'No file opened', "No file opened", QMessageBox.Yes | QMessageBox.No)
    ...
    def saveAsFileNameDialog(self):
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        filename, _= QFileDialog.getSaveFileName(self,"Save File","","All Files (*);; Python Files (*.py);; C++ Files(*.cpp)", options=options)
        split_ex = _.split(' ')
        extension = ''
